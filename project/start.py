...
import sys
import playsound
with open('words1.txt','r',encoding='utf-8') as w:
    g=w.readline().split(',')
with open('words2.txt','r',encoding='utf-8') as w:
    h=w.readline().split(',')
...
class mywindow(QtWidgets.QMainWindow):
    ...
    def start_level(self):
        ...
        self.ui.pushButtonText1.setText(g[0+4*(l-1)])
        self.ui.pushButtonText2.setText(h[0+4*(l-1)])
        self.ui.pushButtonText3.setText(g[1+4*(l-1)])
        self.ui.pushButtonText4.setText(g[2+4*(l-1)])
        self.ui.pushButtonText5.setText(h[1+4*(l-1)])
        self.ui.pushButtonText6.setText(g[3+4*(l-1)])
        self.ui.pushButtonText7.setText(h[2+4*(l-1)])
        self.ui.pushButtonText8.setText(h[3+4*(l-1)])
        self.ui.label_errors.setText('0')   
    def proverka(self):
            global g,h,l
            y=2
            x=int(self.ui.label_words.text())
            if self.ui.label_word_1.text()!='' and self.ui.label_word_2.text()!='':
                for i in range(0+4*(l-1),4+4*(l-1)):
                ...
                if y<2:
                     ...
                     if self.ui.label_errors.text()!='3':
    ...
    def btnClicked1(self):
        global g,h
        if self.ui.label_word_1.text()!=g[0+4*(l-1)] and self.ui.label_word_2.text()!=g[0+4*(l-1)]:
          if self.ui.label_word_1.text()!='':
            self.ui.label_word_2.setText(g[0+4*(l-1)])
          else:
            self.ui.label_word_1.setText(g[0+4*(l-1)])
    def btnClicked2(self):
        global g,h
        if self.ui.label_word_1.text()!=h[0+4*(l-1)] and self.ui.label_word_2.text()!=h[0+4*(l-1)]:
         if self.ui.label_word_1.text()!='':
            self.ui.label_word_2.setText(h[0+4*(l-1)])
         else:
            self.ui.label_word_1.setText(h[0+4*(l-1)])
    def btnClicked3(self):
        global g,h
        if self.ui.label_word_1.text()!=g[1+4*(l-1)] and self.ui.label_word_2.text()!=g[1+4*(l-1)]:
         if self.ui.label_word_1.text()!='':
            self.ui.label_word_2.setText(g[1+4*(l-1)])
         else:
            self.ui.label_word_1.setText(g[1+4*(l-1)])
    def btnClicked4(self):
        global g,h
        if self.ui.label_word_1.text()!=g[2+4*(l-1)] and self.ui.label_word_2.text()!=g[2+4*(l-1)]:
         if self.ui.label_word_1.text()!='':
            self.ui.label_word_2.setText(g[2+4*(l-1)])
         else:
            self.ui.label_word_1.setText(g[2+4*(l-1)])
    def btnClicked5(self):
        global g,h
        if self.ui.label_word_1.text()!=h[1+4*(l-1)] and self.ui.label_word_2.text()!=h[1+4*(l-1)]:
         if self.ui.label_word_1.text()!='':
            self.ui.label_word_2.setText(h[1+4*(l-1)])
         else:
            self.ui.label_word_1.setText(h[1+4*(l-1)])
    def btnClicked6(self):
        global g,h
        if self.ui.label_word_1.text()!=g[3+4*(l-1)] and self.ui.label_word_2.text()!=g[3+4*(l-1)]:
         if self.ui.label_word_1.text()!='':
            self.ui.label_word_2.setText(g[3+4*(l-1)])
         else:
            self.ui.label_word_1.setText(g[3+4*(l-1)])
    def btnClicked7(self):
        global g,h
        if self.ui.label_word_1.text()!=h[2+4*(l-1)] and self.ui.label_word_2.text()!=h[2+4*(l-1)]:
          if self.ui.label_word_1.text()!='':
            self.ui.label_word_2.setText(h[2+4*(l-1)])
          else:
            self.ui.label_word_1.setText(h[2+4*(l-1)])
    def btnClicked8(self):
        global g,h
        if self.ui.label_word_1.text()!=h[3+4*(l-1)] and self.ui.label_word_2.text()!=h[3+4*(l-1)]:
          if self.ui.label_word_1.text()!='':
            self.ui.label_word_2.setText(h[3+4*(l-1)])
          else:
            self.ui.label_word_1.setText(h[3+4*(l-1)])
